...
function run() {
  if (GameBoyEmulatorInitialized()) {
    if (!GameBoyEmulatorPlaying()) {
      ...
      // auto palettes
      //gameboy.colors=[0Xacb56b,0X768448,0X3f503f,0X181010]
      if (gameboy.name == 'METROID2') {
        gameboy.colors = [0xaedf1e, 0xb62558, 0x047e60, 0x2c1700];
      }
      if (gameboy.name == 'POKEMON GRE') {
        gameboy.colors = [0xacb56b, 0x768448, 0x3f503f, 0x181010];
      }
      if (gameboy.name == 'POKEMON RED') {
        gameboy.colors = [0xffefff, 0xff9999, 0x84739c, 0x181010];
      }
      if (gameboy.name == 'POKEMON BLU') {
        gameboy.colors = [0xffefff, 0x99cccc, 0x84739c, 0x181010];
      }
      if (gameboy.name == 'POKEMON YEL') {
        gameboy.colors = [0xffffef, 0xcccc66, 0x996633, 0x181010];
      }
